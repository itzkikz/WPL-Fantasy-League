...
## Corpus Check
- 448 files · ~513,805 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4177 nodes · 9314 edges · 378 communities (189 shown, 189 thin omitted)
...
- `getPlayerStatsMap()` --indirect_call--> `ps()`  [INFERRED]
  server/src/lib/fantasyScore.ts → ui/.vercel/output/static/assets/index-D6bAIqfo.js
...
Cohesion: 0.11
Nodes (5): SideNavbar(), Props, NotificationProps, UserSettingsProps, path()
...
Cohesion: 0.07
Nodes (29): API_ENDPOINTS, QUERY_KEYS, managerApi, managerQueries, ManagerDetailsResponse, SubstitutionRequest, SubstitutionResponse, TeamDetails (+21 more)
...
Cohesion: 0.06
Nodes (58): connectDB(), EXCLUDED_KEYS, pickFields(), ILeague, League, LeagueSchema, ISeason, Season (+50 more)

### Community 8 - "Server API Controllers"
Cohesion: 0.15
Nodes (42): dashboard(), details(), myFixtures(), aggregateMatchStats(), BREAKDOWN_ORDER, breakdownLabel(), breakdownValue(), buildCurrentWeek() (+34 more)
...
Cohesion: 0.09
Nodes (55): bulkCreateH2HFixtures(), completeGameweek(), createAdminFact(), createFantasyTeam(), createGameweek(), createH2HFixture(), deleteAdminFact(), deleteH2HFixture() (+47 more)

### Community 11 - "Server Entry & Middleware"
Cohesion: 0.07
Nodes (25): getFixtures(), reportDevice(), app, auth, cors, credentials, fs, { google } (+17 more)
...
Cohesion: 0.02
Nodes (124): T, addObserver(), am, ar(), Bg(), bh, bm, Bt() (+116 more)

### Community 18 - "Head-to-Head Feature"
Cohesion: 0.09
Nodes (28): apiClient, h2hApi, useAdminH2HLeague(), useAdminH2HLeagueFixtures(), useH2HLeagueFixtures(), useH2HStandings(), useMyH2HLeagues(), H2HFixture (+20 more)
...
Cohesion: 0.07
Nodes (54): aa(), af(), ba(), bf(), bi(), bs(), ca(), Di() (+46 more)

### Community 21 - "Server Sync & Fantasy Team"
Cohesion: 0.10
Nodes (30): PitchPlayerCard(), useMyFixtures(), useManagerDetails(), standingsApi, useManagerOverview(), useStandings(), useStandingsFixtures(), useTeamDetails() (+22 more)
...
Cohesion: 0.12
Nodes (36): m(), p(), al(), be(), ce(), clearTimeout(), ee(), fa() (+28 more)

### Community 25 - "Player Detail Components"
Cohesion: 0.13
Nodes (22): substitution(), Formation, FormationResult, Player, RoleKey, setCaptain(), setCaptaincyRole(), setViceCaptain() (+14 more)
...
Cohesion: 0.10
Nodes (24): SheetController, buildFantasyTeamGamewiseRows(), FANTASY_GAMEWISE_HEADERS, fantasyGamewiseRowsToValues(), FantasyTeamGamewiseRow, getPlayerStatsMap(), lineupLabel(), roleLabel() (+16 more)
...
Cohesion: 0.05
Nodes (87): U(), A(), activate(), addCacheListener(), addFetchListener(), addToCacheList(), Ae(), _awaitComplete() (+79 more)

### Community 44 - "App Entry & Theme Context"
Cohesion: 0.29
Nodes (8): SplashScreen(), authApi, useValidateToken(), authQueries, LoginRequest, LoginResponse, User, ValidateResponse
...
Cohesion: 0.19
Nodes (11): E, a, o, F, ne(), te(), o, A() (+3 more)
...
Cohesion: 0.09
Nodes (69): u(), u(), W(), at(), Bu(), cf(), Ci(), co() (+61 more)
...
Cohesion: 0.20
Nodes (11): PitchPlayerCardProps, Player, Formation, MyTeamListViewProps, getRowJustify(), MyTeamPitch(), MyTeamPitchProps, FixtureRow (+3 more)
...
Cohesion: 0.16
Nodes (27): $(), ae(), B(), F(), G(), I(), ie(), J() (+19 more)
...
Cohesion: 0.10
Nodes (40): ae(), ao(), cancel(), cancelQueries(), catch(), defaultQueryOptions(), ensureInfiniteQueryData(), ensureQueryData() (+32 more)
...
Cohesion: 0.07
Nodes (32): Button(), ButtonProps, CheckboxProps, Overlay(), HeaderProps, AngleLeftProps, getPointsImpact(), PlayerDetails() (+24 more)
...
Cohesion: 0.13
Nodes (25): _(), _, v, y(), g, b(), v(), y() (+17 more)
...
Cohesion: 0.06
Nodes (25): AdminPlayer, FantasyTeamForm(), FantasyTeamFormProps, normalizePos(), Modal(), ModalProps, useFixturePlayers(), FixturePlayerStats (+17 more)

### Community 94 - "Community 94"
Cohesion: 0.10
Nodes (39): accessor(), bd(), bindMethods(), bn(), br(), constructor(), delete(), Dr() (+31 more)

### Community 95 - "Community 95"
Cohesion: 0.12
Nodes (49): a(), ap(), bp(), dc(), Dd(), Dp(), Du(), ec() (+41 more)
...
Cohesion: 0.08
Nodes (43): $(), ad(), add(), an(), bc(), build(), cc(), cn() (+35 more)
...
Cohesion: 0.17
Nodes (13): g(), a, o, d(), l(), o, u(), C() (+5 more)
...
Cohesion: 0.12
Nodes (33): E(), s(), Ai(), b(), ct(), Df(), E(), Eg() (+25 more)

### Community 143 - "Community 143"
Cohesion: 0.20
Nodes (18): C(), w(), x(), y, S(), x, y, c() (+10 more)
...
Cohesion: 0.18
Nodes (16): As(), concat(), cs(), ds(), es(), fs(), ls(), ms() (+8 more)
...
Cohesion: 0.20
Nodes (13): ThemeToggle(), Theme, ThemeContext, ThemeContextType, ThemeProvider(), ThemeProviderProps, useTheme(), useLogin() (+5 more)
...
Cohesion: 0.29
Nodes (8): MainLayout(), BeforeInstallPromptEvent, PWAInstallBanner(), WindowEventMap, detectDeviceInfo(), DeviceInfo, reportDevice(), safeLocalStorage
...
Cohesion: 0.11
Nodes (30): Ac(), bo(), cl(), Da(), dl(), Do(), el(), eo() (+22 more)
...
Cohesion: 0.13
Nodes (23): Au(), cd(), _d(), dt(), ed(), getCurrentResult(), getObserversCount(), isActive() (+15 more)
...
### Community 245 - "Route"
Cohesion: 0.33
Nodes (11): A(), ae(), ce(), E, j(), k(), M(), N() (+3 more)
...
### Community 361 - "globals"
Cohesion: 0.67
Nodes (3): $type, $value, 0

### Community 362 - "google-auth-library"
Cohesion: 0.67
Nodes (3): $type, $value, 12

### Community 365 - "@tanstack/react-virtual"
Cohesion: 0.67
...
- **Why does `ps()` connect `Server API Controllers` to `Community 104`, `Gameweek Pitch View`, `Community 145`, `Team Details Page`, `Manager API & Admin Routes`, `Community 95`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `error` connect `Server Admin API` to `Player.ts`, `Community 104`, `Server API Controllers`, `Server Database & Seeding`, `Server Entry & Middleware`, `Community 148`, `Player Detail Components`, `Manager API & Admin Routes`, `Community 93`, `Community 158`, `Sofascore Scraper Scripts`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `useUserStore` connect `Community 148` to `UI Navigation & Layout`, `Home Dashboard Components`, `Community 107`, `App Entry & Theme Context`, `Head-to-Head Feature`, `Notifications Feature`, `Community 87`, `Community 158`?**
