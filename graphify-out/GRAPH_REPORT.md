...
Cohesion: 0.08
Nodes (28): apiClient, API_ENDPOINTS, QUERY_KEYS, Modal(), ModalProps, managerQueries, Route, FixtureDetails() (+20 more)
...
Cohesion: 0.17
Nodes (16): managerApi, ManagerDetailsResponse, SubstitutionRequest, SubstitutionResponse, Player, Formation, TeamDetails, MyTeamListViewProps (+8 more)
...
Cohesion: 0.10
Nodes (28): PitchPlayerCard(), PitchPlayerCardProps, PlayerInfo(), useMyFixtures(), useManagerDetails(), standingsApi, useManagerOverview(), useStandings() (+20 more)
...
- **Why does `error` connect `Server Admin API` to `Community 160`, `Player.ts`, `Server API Controllers`, `Server Database & Seeding`, `Server Entry & Middleware`, `App Entry & Theme Context`, `Manager Pick Team`, `Gameweek Pitch View`, `Server Sync & Fantasy Team`, `Community 85`, `Server Lineup & Substitution`, `Sofascore Scraper Scripts`?**
