...
## Corpus Check
- 439 files · ~499,447 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4122 nodes · 9145 edges · 356 communities (170 shown, 186 thin omitted)
...
## Communities (356 total, 186 thin omitted)

### Community 0 - "UI Navigation & Layout"
Cohesion: 0.08
Nodes (5): AngleDownProps, AngleRightProps, Props, NotificationProps, UserSettingsProps
...
Cohesion: 0.05
Nodes (40): apiClient, API_ENDPOINTS, QUERY_KEYS, Modal(), ModalProps, authApi, authQueries, LoginRequest (+32 more)
...
Cohesion: 0.16
Nodes (42): dashboard(), details(), myFixtures(), substitution(), aggregateMatchStats(), BREAKDOWN_ORDER, breakdownLabel(), breakdownValue() (+34 more)
...
Cohesion: 0.10
Nodes (52): completeGameweek(), createAdminFact(), createFantasyTeam(), createGameweek(), createH2HFixture(), deleteAdminFact(), deleteH2HFixture(), deleteH2HLeague() (+44 more)

### Community 11 - "Server Entry & Middleware"
Cohesion: 0.06
Nodes (27): getFixtures(), getFilters(), SyncController, app, auth, cors, credentials, fs (+19 more)
...
Cohesion: 0.12
Nodes (22): Overlay(), Info(), InfoProps, ListPlayerItem(), ListPlayerItemProps, playersApi, usePlayerFilters(), usePlayers() (+14 more)

### Community 17 - "Gameweek Pitch View"
Cohesion: 0.02
Nodes (190): m(), T, addObserver(), ae(), am, an(), ao(), ar() (+182 more)
...
Cohesion: 0.10
Nodes (22): homeApi, BestPerformer, FantasyArticle, FixtureDifficultyItem, FixturePlayer, GameweekHistory, GameweekProgress, HomePageData (+14 more)

### Community 20 - "Server Auth & H2H"
Cohesion: 0.19
Nodes (16): managerApi, managerQueries, ManagerDetailsResponse, SubstitutionRequest, SubstitutionResponse, Player, Formation, TeamDetails (+8 more)

### Community 21 - "Server Sync & Fantasy Team"
Cohesion: 0.10
Nodes (24): PitchPlayerCard(), PitchPlayerCardProps, PlayerInfo(), useManagerOverview(), useTeamDetails(), mapPosition(), positionMap, getPlayerDisplayPrice() (+16 more)
...
Cohesion: 0.12
Nodes (22): Formation, FormationResult, Player, RoleKey, setCaptain(), setCaptaincyRole(), setViceCaptain(), canSwap() (+14 more)
...
Cohesion: 0.08
Nodes (30): SheetController, CREDENTIALS_PATH, SCOPES, buildFantasyTeamGamewiseRows(), FANTASY_GAMEWISE_HEADERS, fantasyGamewiseRowsToValues(), FantasyTeamGamewiseRow, getPlayerStatsMap() (+22 more)

### Community 30 - "Admin Fantasy Team Routes"
Cohesion: 0.12
Nodes (24): Cell, deleteNotification(), markAllAsRead(), markAsRead(), notifications(), Row, send(), subscribe() (+16 more)
...
Cohesion: 0.11
Nodes (24): adminApi, SubstitutionHistoryRecord, SubstitutionPlayer, SubstitutionType, transfersApi, FreeAgentPlayer, Transfer, TransferInput (+16 more)
...
Cohesion: 0.20
Nodes (15): detectKind(), KindConfig, KINDS, NotificationItem(), notificationApi, useDeleteNotification(), useMarkAllAsRead(), useMarkAsRead() (+7 more)

### Community 53 - "Team Details Page"
Cohesion: 0.06
Nodes (93): u(), u(), W(), a(), ap(), As(), at(), Au() (+85 more)
...
Cohesion: 0.06
Nodes (59): aa(), Ac(), accessor(), af(), bo(), bp(), cf(), dc() (+51 more)
...
Cohesion: 0.05
Nodes (62): $(), l, l, p(), E, ae(), B(), F() (+54 more)
...
Cohesion: 0.07
Nodes (56): ad(), add(), ba(), bc(), bf(), bi(), ca(), cn() (+48 more)
...
Cohesion: 0.12
Nodes (19): useHomePage(), useMyFixtures(), homeQueries, standingsApi, useFixturePlayers(), useStandings(), useStandingsFixtures(), standingsQueries (+11 more)

### Community 88 - "Community 88"
Cohesion: 0.06
Nodes (104): _(), _(), _, g(), v, y(), g, f (+96 more)
...
Cohesion: 0.07
Nodes (72): $(), bd(), bn(), br(), bs(), clear(), concat(), constructor() (+64 more)

### Community 95 - "Community 95"
Cohesion: 0.12
Nodes (34): al(), be(), Bl(), cl(), Da(), dl(), el(), eu() (+26 more)
...
Cohesion: 0.31
Nodes (15): AdminFixturesIcon(), AdminH2HIcon(), AdminLeaguesIcon(), AdminSettingsIcon(), AdminSubstitutionsIcon(), AdminTeamsIcon(), H2HIcon(), HomeIcon() (+7 more)
...
Cohesion: 0.08
Nodes (24): MainLayout(), ThemeToggle(), Theme, ThemeContext, ThemeContextType, ThemeProvider(), ThemeProviderProps, useTheme() (+16 more)
...
- **Why does `ps()` connect `Server API Controllers` to `Gameweek Pitch View`, `Team Details Page`, `Manager API & Admin Routes`, `Community 93`, `Community 94`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `useUserStore` connect `Community 143` to `UI Navigation & Layout`, `Home Dashboard Components`, `Community 107`, `Notifications Feature`, `Community 87`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `error` connect `Server Admin API` to `Server Notifications & Points`, `Player.ts`, `Server API Controllers`, `Server Database & Seeding`, `Server Entry & Middleware`, `Community 143`, `Sofascore Scraper Scripts`, `Manager API & Admin Routes`, `Community 93`, `Community 158`?**
