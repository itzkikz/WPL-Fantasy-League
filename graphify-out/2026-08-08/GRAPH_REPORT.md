# Graph Report - WPL-Fantasy-League  (2026-08-08)

## Corpus Check
- 439 files · ~501,770 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4125 nodes · 9151 edges · 345 communities (177 shown, 168 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1055 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `94617613`
...
## Communities (345 total, 168 thin omitted)
...
Cohesion: 0.05
Nodes (34): API_ENDPOINTS, QUERY_KEYS, Modal(), ModalProps, playersApi, PlayerFilters, PlayerActionModalProps, FactItem (+26 more)
...
Cohesion: 0.07
Nodes (45): connectDB(), ILeague, League, LeagueSchema, ISeason, Season, SeasonSchema, buildStandingsUrl() (+37 more)

### Community 8 - "Server API Controllers"
Cohesion: 0.12
Nodes (49): dashboard(), details(), myFixtures(), aggregateMatchStats(), BREAKDOWN_ORDER, breakdownLabel(), breakdownValue(), buildCurrentWeek() (+41 more)
...
Cohesion: 0.11
Nodes (47): buildRoundRobinSchedule(), buildSingleGwPairings(), completeGameweek(), createAdminFact(), createFantasyTeam(), createGameweek(), createH2HFixture(), deleteAdminFact() (+39 more)

### Community 11 - "Server Entry & Middleware"
Cohesion: 0.07
Nodes (24): getFixtures(), app, auth, cors, credentials, fs, { google }, sheets (+16 more)
...
Cohesion: 0.14
Nodes (17): Overlay(), Info(), InfoProps, ListPlayerItem(), ListPlayerItemProps, usePlayerFilters(), usePlayers(), playersQueries (+9 more)

### Community 17 - "Gameweek Pitch View"
Cohesion: 0.02
Nodes (229): $(), m(), p(), E(), T, accessor(), addObserver(), ae() (+221 more)

### Community 18 - "Head-to-Head Feature"
Cohesion: 0.14
Nodes (20): apiClient, h2hApi, useAdminH2HLeague(), useAdminH2HLeagueFixtures(), useH2HLeagueFixtures(), useH2HStandings(), useMyH2HLeagues(), H2HFixture (+12 more)
...
Cohesion: 0.10
Nodes (29): PitchPlayerCard(), PitchPlayerCardProps, PlayerInfo(), PaginatedResponse, Player, PlayerFilterOptions, SofaScoreStats, useManagerOverview() (+21 more)
...
Cohesion: 0.11
Nodes (29): substitution(), convertToFormation(), Formation, FormationResult, Player, RoleKey, setCaptain(), setCaptaincyRole() (+21 more)
...
Cohesion: 0.20
Nodes (8): SheetController, FANTASY_GAMEWISE_HEADERS, fantasyGamewiseRowsToValues(), PLAYER_STATS_SHEET_HEADERS, getSheets(), ApiConfig, ApiConfigSchema, IApiConfig
...
Cohesion: 0.10
Nodes (21): body-parser, cors, dotenv, express, google-auth-library, jsonwebtoken, mongoose, dependencies (+13 more)
...
Cohesion: 0.05
Nodes (87): k, A(), activate(), addCacheListener(), addFetchListener(), addToCacheList(), Ae(), _awaitComplete() (+79 more)

### Community 44 - "App Entry & Theme Context"
Cohesion: 0.16
Nodes (15): ThemeToggle(), Theme, ThemeContext, ThemeContextType, ThemeProvider(), ThemeProviderProps, useTheme(), authApi (+7 more)
...
Cohesion: 0.18
Nodes (21): $(), ae(), B(), F(), G(), I(), J(), K() (+13 more)
...
Cohesion: 0.04
Nodes (218): _(), u(), u(), y(), g, W(), d(), a() (+210 more)
...
Cohesion: 0.09
Nodes (27): useHomePage(), useMyFixtures(), useManagerDetails(), standingsApi, useFixturePlayers(), useStandings(), useStandingsFixtures(), useTeamDetails() (+19 more)

### Community 88 - "Community 88"
Cohesion: 0.06
Nodes (86): l, g(), l, E, x, y, ie(), M() (+78 more)
...
Cohesion: 0.10
Nodes (19): CREDENTIALS_PATH, SCOPES, SyncController, FantasyTeamSchema, HistorySchema, IFantasyTeam, IHistory, IPick (+11 more)

### Community 93 - "Community 93"
Cohesion: 0.11
Nodes (19): client, login(), privateKey, computePicksPoints(), getH2HLeagueFixturesPublic(), getH2HStandings(), getLeagueAllGWPoints(), getMyH2HLeagues() (+11 more)

### Community 94 - "Community 94"
Cohesion: 0.07
Nodes (47): _, b(), v(), y(), bd(), bindMethods(), bn(), br() (+39 more)

### Community 95 - "Community 95"
Cohesion: 0.10
Nodes (38): v, C(), w(), x(), y, S(), c(), a() (+30 more)
...
- **Why does `ps()` connect `Server API Controllers` to `Gameweek Pitch View`, `Community 106`, `Team Details Page`, `Community 93`?**
...
- **Why does `error` connect `Server Admin API` to `Server Notifications & Points`, `Player.ts`, `Server API Controllers`, `Server Database & Seeding`, `Community 92`, `Community 87`, `Server Lineup & Substitution`, `Player Detail Components`, `Manager API & Admin Routes`, `Community 93`, `Community 158`, `Sofascore Scraper Scripts`?**
