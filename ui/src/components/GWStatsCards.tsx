    ...
    <div className="flex-none px-12 sm:px-6 lg:px-8">
      <div className="flex items-center justify-between max-w-md mx-auto gap-1">
        ...
        <div className="relative">
          <div className="text-center bg-linear-to-br from-light-primary to-light-primary rounded-2xl px-4 py-2 shadow-lg">
            <p className="text-xl font-bold">{totalGWScore}</p>
            <p className="text-xs mt-1">Total Pts</p>
          </div>
        </div>

        <button className="text-center group">
          <p className="text-base font-bold">{highest}</p>
