...
const PWAInstallBanner: React.FC = () => {
  ...
  useEffect(() => {
    // One-time cleanup: remove the legacy 7-day dismissal keys written by older
    // versions (dismissal is now session-scoped), so users who dismissed under
    // the old logic see the install prompt again on their next visit.
              ...
              <div className="min-w-0">
                ...
                {isIOSChrome ? (
                  <ol className="text-xs text-text-muted list-decimal list-inside space-y-0.5 leading-relaxed">
                    ...
                    <li>
                      Tap <span className="font-semibold text-text-secondary">View More</span>
                    </li>
                    <li>
                  ...
                  <ol className="text-xs text-text-muted list-decimal list-inside space-y-0.5 leading-relaxed">
                    ...
                    <li>
                      Tap <span className="font-semibold text-text-secondary">View More</span> and select{" "}
