  ...
  return (
    <div className="flex-none pt-2 pb-1">
      <div className="flex items-center justify-between max-w-xs mx-auto px-4">
        ...
        >
          <AngleLeft height="4" width="4" />
        </button>
        
        <div className="text-center">
          <p className="text-[9px] font-bold uppercase tracking-widest text-indigo-500 mb-0.5">Gameweek</p>
          <h2 className="text-lg md:text-xl font-black text-gray-900 dark:text-white leading-none">
            {gameWeek === 0 ? "-" : gameWeek}
          </h2>
        </div>
